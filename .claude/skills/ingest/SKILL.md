...
Parse source files into individual `.md` in `docs/raw/`. Auto-detect format from file extension and content shape. No script — Claude parses and outputs directly.
